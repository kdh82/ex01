                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <c:if test="${empty login }">
                    	<a href="/ex01/user/login" class="btn btn-default btn-flat">Sign in</a>
                    	</c:if>
                    	<c:if test="${!empty login }">
                      <a href="/ex01/user/logout" class="btn btn-default btn-flat">Sign out</a>
                      </c:if>
                    </div>
                  </li>
                </ul>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="../examples/404.html"><i class="fa fa-circle-o"></i>${pageContext.request.contextPath}/resources4 Error</a></li>
